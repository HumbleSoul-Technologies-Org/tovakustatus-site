    ...
    <div className="space-y-8">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">Add, edit, and manage events and activities</p>
        </div>
        <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
          ...
          <DialogContent className="max-h-[90vh] overflow-y-auto">
            <DialogHeader>
              <DialogTitle>{editingEvent ? 'Edit' : 'Add New'} Event</DialogTitle>
            </DialogHeader>
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="space-y-2">
                <Label htmlFor="event-full-description">Full Description (Optional)</Label>
                <Textarea 
              ...
              <div className="space-y-2">
                ...
                <Select 
                  ...
                  onValueChange={(value: "upcoming" | "ongoing" | "past") => setFormData({...formData, status: value})}
                >
            ...
            <table className="w-full">
              ...
              <tbody>
                {filteredEvents.map((event) => (
                  <tr key={event.id} className="border-b border-border hover:bg-muted/50" data-testid={`event-row-${event.id}`}>
