    ...
    <div>
      <section className="py-16 md:py-24 bg-background">
        <div className="max-w-4xl mx-auto px-4 md:px-8">
          ...
          <article>
            <div className="mb-6">
              <Badge variant="secondary" className="mb-4" data-testid="blog-detail-category">{post.category}</Badge>
              <h1 className="text-4xl md:text-5xl font-bold mb-6" data-testid="blog-detail-title">{post.title}</h1>
              ...
              <div className="flex flex-wrap items-center gap-4 text-sm text-muted-foreground mb-8">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span data-testid="blog-detail-date">{post.date}</span>
                </div>
                {post.readTime && (
                  <div className="flex items-center gap-2">
                    <Clock className="h-4 w-4" />
                    <span data-testid="blog-detail-read-time">{post.readTime}</span>
                  </div>
                )}
              </div>
            </div>
            ...
            <div className="prose prose-lg max-w-none mb-12">
              <p className="text-xl text-muted-foreground leading-relaxed mb-8" data-testid="blog-detail-excerpt">
                {post.excerpt}
              </p>
              
              {post.content && (
                <div className="text-muted-foreground leading-relaxed whitespace-pre-line" data-testid="blog-detail-content">
                  {post.content}
                </div>
              )}
            </div>
            ...
            <Card className="p-6 bg-card">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">Contributor at Tova ku Status</p>
                </div>
              </div>
            </Card>
